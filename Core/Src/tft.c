...
void tft_init(void)
{
	...
	static uint8_t buf1[TFT_HOR_RES * 24 * 2];
	static uint8_t buf2[TFT_HOR_RES * 24 * 2];
	disp = lv_display_create(800, 480);
	lv_display_set_buffers(disp, buf1, buf2, TFT_HOR_RES * 24 * 2, LV_DISP_RENDER_MODE_PARTIAL);
